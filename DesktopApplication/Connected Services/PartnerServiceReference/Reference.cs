...
namespace DesktopApplication.PartnerServiceReference {
    using System.Data;
    ...
    public interface PartnerWebServicesSoap {
        ...
        DesktopApplication.PartnerServiceReference.AddEventResponse AddEvent(DesktopApplication.PartnerServiceReference.AddEventRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AddEvent", ReplyAction="*")]
        System.Threading.Tasks.Task<DesktopApplication.PartnerServiceReference.AddEventResponse> AddEventAsync(DesktopApplication.PartnerServiceReference.AddEventRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        DesktopApplication.PartnerServiceReference.UpdateEventResponse UpdateEvent(DesktopApplication.PartnerServiceReference.UpdateEventRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/UpdateEvent", ReplyAction="*")]
        System.Threading.Tasks.Task<DesktopApplication.PartnerServiceReference.UpdateEventResponse> UpdateEventAsync(DesktopApplication.PartnerServiceReference.UpdateEventRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface PartnerWebServicesSoapChannel : DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PartnerWebServicesSoapClient : System.ServiceModel.ClientBase<DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap>, DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        DesktopApplication.PartnerServiceReference.AddEventResponse DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap.AddEvent(DesktopApplication.PartnerServiceReference.AddEventRequest request) {
        ...
        public string AddEvent(string eventid, string event_name, string ticket_price, string email, string date, string time, string location, string description, byte[] imageData, int remainingTickets) {
            DesktopApplication.PartnerServiceReference.AddEventRequest inValue = new DesktopApplication.PartnerServiceReference.AddEventRequest();
            ...
            DesktopApplication.PartnerServiceReference.AddEventResponse retVal = ((DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap)(this)).AddEvent(inValue);
            return retVal.AddEventResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<DesktopApplication.PartnerServiceReference.AddEventResponse> DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap.AddEventAsync(DesktopApplication.PartnerServiceReference.AddEventRequest request) {
            return base.Channel.AddEventAsync(request);
        }
        
        public System.Threading.Tasks.Task<DesktopApplication.PartnerServiceReference.AddEventResponse> AddEventAsync(string eventid, string event_name, string ticket_price, string email, string date, string time, string location, string description, byte[] imageData, int remainingTickets) {
            DesktopApplication.PartnerServiceReference.AddEventRequest inValue = new DesktopApplication.PartnerServiceReference.AddEventRequest();
            inValue.eventid = eventid;
            inValue.event_name = event_name;
            inValue.ticket_price = ticket_price;
            ...
            inValue.imageData = imageData;
            inValue.remainingTickets = remainingTickets;
            return ((DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap)(this)).AddEventAsync(inValue);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        DesktopApplication.PartnerServiceReference.UpdateEventResponse DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap.UpdateEvent(DesktopApplication.PartnerServiceReference.UpdateEventRequest request) {
        ...
        public string UpdateEvent(string eventId, string event_name, string ticket_price, string date, string time, string location, string description, byte[] imageData, int soldTickets, int remainingTickets) {
            DesktopApplication.PartnerServiceReference.UpdateEventRequest inValue = new DesktopApplication.PartnerServiceReference.UpdateEventRequest();
            inValue.eventId = eventId;
            inValue.event_name = event_name;
            inValue.ticket_price = ticket_price;
            inValue.date = date;
            ...
            inValue.remainingTickets = remainingTickets;
            DesktopApplication.PartnerServiceReference.UpdateEventResponse retVal = ((DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap)(this)).UpdateEvent(inValue);
            return retVal.UpdateEventResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<DesktopApplication.PartnerServiceReference.UpdateEventResponse> DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap.UpdateEventAsync(DesktopApplication.PartnerServiceReference.UpdateEventRequest request) {
            return base.Channel.UpdateEventAsync(request);
        }
        
        public System.Threading.Tasks.Task<DesktopApplication.PartnerServiceReference.UpdateEventResponse> UpdateEventAsync(string eventId, string event_name, string ticket_price, string date, string time, string location, string description, byte[] imageData, int soldTickets, int remainingTickets) {
            DesktopApplication.PartnerServiceReference.UpdateEventRequest inValue = new DesktopApplication.PartnerServiceReference.UpdateEventRequest();
            inValue.eventId = eventId;
            inValue.event_name = event_name;
            inValue.ticket_price = ticket_price;
            ...
            inValue.soldTickets = soldTickets;
            inValue.remainingTickets = remainingTickets;
            return ((DesktopApplication.PartnerServiceReference.PartnerWebServicesSoap)(this)).UpdateEventAsync(inValue);
        }
    }
}
